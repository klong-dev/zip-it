  ...
  const handleEmailAuth = async (e: React.FormEvent) => {
    ...
    try {
      if (isLogin) {
        ...
        const { error } = await authHelpers.signUpWithEmail(
          formData.fullName,
          formData.email,
          formData.password
        );
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#f6f6f6] to-white flex items-center justify-center py-12 px-4">
      <div className="max-w-md w-full">
        ...
        <Link 
          href="/" 
          className="inline-flex items-center gap-2 text-[#980b15] hover:text-[#7a0912] mb-6 transition-colors"
        >
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-500 mt-2">
              {isLogin 
                ? "Đăng nhập để quản lý đơn hàng và địa chỉ giao hàng" 
          ...
          <form onSubmit={handleEmailAuth} className="space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#980b15] focus:border-transparent outline-none transition-all"
                  />
                </div>
              </div>
            )}
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  placeholder="••••••••"
                  className="w-full pl-10 pr-12 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#980b15] focus:border-transparent outline-none transition-all"
                />
                <button
                  type="button"
            ...
            {isLogin && (
              <div className="flex justify-end">
                <button
                  ...
                  className="text-sm text-[#980b15] hover:text-[#7a0912] font-medium"
                >
                  Quên mật khẩu?
                </button>
              </div>
            ...
            <button
              ...
              className="w-full py-3 bg-[#980b15] text-white rounded-lg font-medium hover:bg-[#7a0912] transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
